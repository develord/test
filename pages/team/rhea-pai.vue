              ...
              <div class="team-block-two wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;">
                <div class="inner-box" style="padding: 24px 0px;">
                  <div class="image-box" style="    border-radius: 25px;margin: auto;width: 233px;height: 233px;">
                    <img
                      v-lazy="{ src: teams[2].img, loading: teams[2].img }"
                      width="140"
                      height="140"
                    ...
                    <ul class="contact-box clearfix" style="right: -60px;">
                      ...
                      <div v-if="teams[2].linkedin || teams[2].researchgate|| teams[2].github" class="social-links">
                        <li>
                          <a target="_blank" :href="teams[2].twitter" style="background-color:transparent; color: rgb(249,+50,+110)">
                            <img style="width: 35px;" :src="'../images/icotwitter.png'">
                          </a>
                        </li>
                        <li>
                          <a target="_blank" :href="teams[2].google" style="background-color:transparent; color: rgb(249,+50,+110)">
                            <img style="width: 35px;" :src="'../images/icogooglesch.png'">
                          </a>
                        </li>
                        <li>
                          <a target="_blank" :href="teams[2].linkedin" style="background-color:transparent; color: rgb(249,+50,+110)">
                            <img style="width: 35px;" :src="'../images/icolinkedin.png'">
                          </a>
                        </li>
                        <li>
                          <a target="_blank" :href="teams[2].github" style="background-color:transparent; color: rgb(249,+50,+110)">
                            <img style="width: 35px;" :src="'../images/icogithub.png'">
                          </a>
                        </li>
                        <li>
                          <a target="_blank" :href="teams[2].researchgate" style="background-color:transparent; color: rgb(249,+50,+110)">
                  ...
                  <div class="lower-content">
                    <NuxtLink :to="teams[2].link" title="giving" class="hvr-underline-from-left1">
                      <h4 style="text-align: center;">
                        {{ teams[2].name }}
                      </h4>
                    </NuxtLink>
                    <span class="designation">{{ teams[2].title }}</span>
                    <div class="designation">
                      <a target="_blank" :href="teams[2].cv" style="width: 44px;background-color:transparent; color: rgb(249,+50,+110)">
                    ...
                    <div style="padding: 18px 34px;">
                      ...
                      <span class="designation">{{ teams[2].degree }}</span>
                    </div>
        ...
        <div class="col-lg-8 col-md-6 col-sm-12">
          <div class="biography">
            ...
            <p>
              ...
              related projects, where her objective was primarily on optimizing single cell RNA-seq
              experiments on patient samples. She ventured into spatial transcriptomics and is gaining
              expertise in the area of multicolor fluorescent in situ mRNA hybridization (FISH) images.
              She is interested in studying tumor heterogeneity and evolution using single cell genomics
              and spatial transcriptomics. Her other interests include photography, exploring new cuisines
              and leisure travel.
            </p>
            ...
            <ul>
              <li style="list-style: circle;">
                <p style="text-align: left;">
                  <a
                    target="_blank"
                    href="https://www.cell.com/cell/fulltext/S0092-8674(20)31082-5"
                  >Onco-fetal Reprogramming of Endothelial Cells Drives Immunosuppressive Macrophages in Hepatocellular Carcinoma.</a>
                </p>
              </li>
              <li style="list-style: circle;">
                <p style="text-align: left;">
                  <a
                    target="_blank"
                    href="https://www.biorxiv.org/content/10.1101/2020.03.23.002832v1"
                  >scRNA-seq reveals ACE2 and TMPRSS2 expression in TROP2+ Liver Progenitor Cells: Implications in COVID-19 associated Liver Dysfunction.</a>
                </p>
              </li>
              <li style="list-style: circle;">
                <p style="text-align: left;">
                  <a
                    target="_blank"
                    href="https://link.springer.com/article/10.1007/s41745-020-00178-1"
                  >Single‐cell RNA‐sequencing for Precision Oncology: Current state-of-art.</a>
                </p>
              </li>
            </ul>
          </div>
