                ...
                <div class="inner-box" style="padding: 24px 0px;">
                  <div class="image-box" style="    border-radius: 25px;margin: auto;width: 233px;height: 233px;">
                    ...
                    <ul class="contact-box clearfix" style="right: -60px;">
                      ...
                      <div v-if="teams[1].linkedin || teams[1].researchgate|| teams[1].github" class="social-links">
                        <li>
                          <a target="_blank" :href="teams[1].twitter" style="background-color:transparent; color: rgb(249,+50,+110)">
                            <img style="width: 35px;" :src="'../images/icotwitter.png'">
                          </a>
                        </li>
                        <li>
                          <a target="_blank" :href="teams[1].google" style="background-color:transparent; color: rgb(249,+50,+110)">
                            <img style="width: 35px;" :src="'../images/icogooglesch.png'">
                          </a>
                        </li>
                        <li>
                          <a target="_blank" :href="teams[1].linkedin" style="background-color:transparent; color: rgb(249,+50,+110)">
                            <img style="width: 35px;" :src="'../images/icolinkedin.png'">
                          </a>
                        </li>
                        <li>
                          <a target="_blank" :href="teams[1].github" style="background-color:transparent; color: rgb(249,+50,+110)">
                            <img style="width: 35px;" :src="'../images/icogithub.png'">
                          </a>
                        </li>
                        <li>
                          <a target="_blank" :href="teams[1].researchgate" style="background-color:transparent; color: rgb(249,+50,+110)">
            ...
            <ul>
              <li style="list-style: circle;">
                <p style="text-align: left;">
                  <a
                    target="_blank"
                    href="https://bmcbioinformatics.biomedcentral.com/articles/10.1186/s12859-020-03832-8"
                  >Identification and utilization of copy number information for correcting Hi-C contact map of cancer cell lines.</a>
                </p>
              </li>
              <li style="list-style: circle;">
                <p style="text-align: left;">
                  <a
                    target="_blank"
                    href="https://bmcbioinformatics.biomedcentral.com/articles/10.1186/s12859-020-3480-3"
                  >Hierarchical discovery of arge-scale and focal copy number alterations in lowcoverage cancer genomes.</a>
                </p>
              </li>
            </ul>
          </div>
