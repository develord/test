...
const Mutation = {
  ...
  createPost: async (_, { journal, pdf, exterlink, authors, title, published, tags, description, h1, content, componentName, image_large, image_small, link, user, category, status }) => {
    const postData = { title, journal, pdf, exterlink, published, authors, tags, description, h1, componentName, content, image_large, image_small, link, user, category, status }
    const post = await new Post(postData)
    return post.save()
  },
  // eslint-disable-next-line camelcase
  updatePost: async (_, { _id, journal, pdf, exterlink, authors, published, tags, title, description, h1, content, componentName, image_large, image_small, link, user, category, status }) => {
    ...
    const data = { title, published, journal, pdf, exterlink, authors, description, tags, h1, content, componentName, image_large, image_small, link, user, category, status }
